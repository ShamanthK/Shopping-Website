...
describe('HeaderComponent', () => {
  ...
  it('should check for get category', () => {
    ...
    component.ngOnInit()
    expect(component.headerOptions).toEqual(['home', "electronics", "jewelery", "men's clothing", "women's clothing", "checkout"])
  });
  ...
  it('should check for login true path /category/product', () => {
    ...
    spyOn(productService, 'getProductByCategory').and.returnValue(of('electronics'))
  ...
  it('should check for login true path /checkout', () => {
    ...
    spyOn(productService, 'getProductByCategory').and.returnValue(of('checkout'))
